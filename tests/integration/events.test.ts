...
describe.runIf(enabled)('GET /api/events', () => {
  ...
  it('filters by status', async () => {
    ...
    await seed.event({ sport_id: sport.id, home_team_id: team.id, away_team_id: team.id, status: 'finished' });
    await seed.event({ sport_id: sport.id, home_team_id: team.id, away_team_id: team.id, status: 'scheduled' });
...
describe.runIf(enabled)('GET /api/events/:id', () => {
  ...
  it('returns event with nested relations', async () => {
    ...
    const event = await seed.event({ sport_id: sport.id, home_team_id: home.id, away_team_id: away.id });
